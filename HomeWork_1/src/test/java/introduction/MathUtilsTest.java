...
public class MathUtilsTest {
	...
	public void testGetCommonDivider() {
		...
		assertNotSame(0, mathUtils.getGreatestCommonDivider(1, 1));
		assertNotSame(5, mathUtils.getGreatestCommonDivider(5, 1));
	}
	...
	public void testGetSumOfDigits() {
		...
		assertNotSame(0, mathUtils.getSumOfDigits(111));
		assertNotSame(1, mathUtils.getSumOfDigits(101));
	}
